<template>
    <div class="container px-md-7 px-lg-11" id="printable">
            ...
            <div class="card-body p-5 p-md-7 p-lg-11">
                <div class="row justify-content-lg-between align-items-sm-center mb-11">
                    <div class="col-sm-6 col-lg-6 order-sm-2 text-sm-right mb-5 mb-sm-0 text-right">
                        <h2 class="h2 font-weight-medium mb-0">
                            Pedido
                            <small class="d-block text-uppercase">{{conclusion.id}}</small>
                        </h2>
                    </div>
                ...
                <div class="row justify-content-md-between mb-7">
                    <div class="col-md-5 col-lg-4">
                        ...
                        <span class="d-block">{{conclusion.relationships.costumer.attributes.name}}</span>
        ...
        <div class="text-right mt-5">
            <button type="button" class="btn btn-secondary btn-sm-wide transition-3d-hover" onclick="window.print();return false;">
                <span class="fas fa-print mr-2"></span>
                Imprimir
            </button>
            <a href="/" class="btn btn-primary btn-sm-wide transition-3d-hover">
