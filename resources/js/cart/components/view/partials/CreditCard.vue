            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-6 mb-2" :class="errors.has('card_holder') ? 'u-has-error' : ''">
                        ...
                        <input type="text" class="form-control" name="card_holder" v-model="card_holder" v-validate="'required'" data-vv-as="'Nome do Titular'">
                    ...
                    async res => {
                        if (res) {
                            await createCardToken(this.card_number, this.brand, this.card_cvv, this.card_expiration_date)
                                .then((response) => {this.token = response.card.token})
                                .catch( (error) => {
